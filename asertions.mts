...
// typeof -> Tipos
// intanceof -> Instancias

// Hacemos la Asercion en la comprobación
...
// To parse this data:
//
//   import { Convert, GitHubResponse } from "./file";
//
//   const gitHubResponse = Convert.toGitHubResponse(json);
//
...
export class Convert {
    public static toGitHubResponse(json: string): GitHubResponse {
        return cast(JSON.parse(json), r("GitHubResponse"));
    }

    public static gitHubResponseToJson(value: GitHubResponse): string {
        return JSON.stringify(uncast(value, r("GitHubResponse")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Item": o([
        ...
        { json: "web_commit_signoff_required", js: "web_commit_signoff_required", typ: true },
